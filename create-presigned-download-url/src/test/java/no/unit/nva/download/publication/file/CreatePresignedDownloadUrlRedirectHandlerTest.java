...
public class CreatePresignedDownloadUrlRedirectHandlerTest {
    ...
    private CreatePresignedDownloadUrlRedirectHandler createPresignedDownloadUrlRedirectHandler;
    ...
    public void setUp() {
        ...
        createPresignedDownloadUrlRedirectHandler =
                new CreatePresignedDownloadUrlRedirectHandler(publicationService, awsS3Service, environment);
    }
    ...
    public void handlerReturnsFoundResponseOnValidInputPublishedPublication() throws IOException,
        ...
        createPresignedDownloadUrlRedirectHandler.handleRequest(inputStream(IDENTIFIER_VALUE, IDENTIFIER_FILE_VALUE),
                output, context);
    ...
    public void handlerReturnsBadRequestResponseOnMalformedIdentifier() throws IOException {
        ...
        createPresignedDownloadUrlRedirectHandler.handleRequest(inputStream(IDENTIFIER, IDENTIFIER_FILE_VALUE), output,
                context);
